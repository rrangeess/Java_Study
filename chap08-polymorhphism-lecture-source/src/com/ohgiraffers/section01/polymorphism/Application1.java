...
//        rabbit.jump();
//
        Animal an1 = new Animal();    // 다형성 x 같은 타입이므로
...
//        Tiger t1 = new Animal();        // 다형성 x
        ...
        * */
        ...
        /* 설명. 부모타입을 강제로 자식 타입으로 형변환 하는 것이 가능하다.(단, 굉장히 조심해야 한다.)*/
//        ((Tiger)an2).bite();
//        ((Rabbit)an2).jump();

        /* 설명. instanceof란?
        *   해당 객체의 타입을 런타임 시점에 확인하기 위한 연산자
        *   객체 instanceof 클래스명의 형식
        * */
        ...
        Animal animal2 = new Tiger();      //다형성을 적용, 자동 형변환(auto-casting), 묵시적 형변환
