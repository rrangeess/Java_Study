package com.ohgiraffers.section01.section03.copy;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        print(copyArr2, "clone을 활용한 사본");

        /* 설명. 3. arraycopy()를 이용한 복사 */
        int[] copyArr3 = new int[originArr.length + 3];      //원본의 크기가 3더 큼
        ...
        print(copyArr4, "arraycopy()를 이용한 사본");
    }
