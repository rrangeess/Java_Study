package com.ohgiraffers.section02.uses.subjecction02;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        Stream<String> strStream = Arrays.stream(sArr);        // 스트림으로 변경하는 과정

        /* 설명. forEach는 자신의 매개변수에 정의된 람다식의 매개변수로 stream의
            각 요소들을 자동으로 넘기며 순회(람다식 실행) */
...
//        strStream.forEach(System.out::println);
        ...
        /* 설명.
        *   Builder를 활용한 스트림 생성
        *   builder는 static<T>로 덮어 있는 메소드이며, 호출시 타입 파라미터를 메소드 호출 방식으로 전달한다.
        * */
